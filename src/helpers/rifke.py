...
from src.constants import JOINTS_INFOS
from src.helpers.geometry import axis_angle_rotation, matrix_to_axis_angle
...
def get_forward_direction(poses, jointstype="smpljoints"):
    assert jointstype in JOINTS_INFOS
    infos = JOINTS_INFOS[jointstype]
